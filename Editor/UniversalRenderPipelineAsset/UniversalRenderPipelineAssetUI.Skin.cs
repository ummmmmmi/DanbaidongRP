...
namespace UnityEditor.Rendering.Universal
{
    internal partial class UniversalRenderPipelineAssetUI
    {
        internal static class Styles
        {
            ...
            public static GUIContent rayTracingText = EditorGUIUtility.TrTextContent("Ray Tracing", "If enabled, the render pipeline will turn raytracing pass on.", "SceneAsset Icon");
            public static readonly string noSupportRayTracingText = "Your current device not support Ray Tracing, please change to DX12(Project Settings->Player->Graphiocs API for Windows) or detach Renderdoc, etc.";
